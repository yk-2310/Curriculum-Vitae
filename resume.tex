...
{High School: Computer Science; CBSE; Class X 10 CGPA; Class XII 96.6\% (468/500)}{2003 -- 2017}
\resumeItemListStart
...
\resumeSubHeadingListStart
\resumeItem{Pneumonia Prediction using Chest X-Ray (Sep.2019):}{An Application that allows the patients to upload their chest X-Ray in order to predict Pneumonia.}
\resumeItem{Pyschiatrist Assistance System (Aug. 2019 - Present):}{An Internally Funded Project to analyse a psychiatric patient and predict the depression level and the treatment required.}
\resumeSubHeadingListEnd
